...
// TODO änderung von const encryptedParams zu const verschluesselnParameter
...
// TODO Implementierung der entschlüsselung und verschlüsselung
// entschlüssen mit cbc
var decrypting2 = CryptoJS.AES.decrypt(
    encryptedParams.toString(), 
    key_enc, {
        iv: iv_enc,
        mode: CryptoJS.mode.CBC,
        });
...
// entschlüssen mit cbc
var decrypting = CryptoJS.AES.decrypt(
    encryptedParams.toString(), 
    key_enc, {
        iv: iv_enc,
        mode: CryptoJS.mode.CBC,
