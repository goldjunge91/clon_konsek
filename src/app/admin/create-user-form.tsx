...
/**
 *CreateUserForm
 * @description Formular-Komponente zum Erstellen neuer Benutzer.
 * @remarks
 * Rendert ein Formular zur Erfassung von Benutzerinformationen.
 * @param {FormProps} props - Die Eigenschaften des Formulars
 * @returns {JSX.Element} Ein Formular zum Erstellen neuer Benutzer
 */
