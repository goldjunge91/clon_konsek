 ...
 * @remarks
 * Dient als Einstiegspunkt und bietet einen Überblick über die Hauptfunktionen.
			...
			<div className="container-landingpage">
				<div className="layout-full-left">
					...
					<button className="primary-button">
						<Link href="/create-task">Create a new print file</Link>
					</button>
					<p className="footer-text">
						Provided by Konsek Engineering & Consulting GmbH
						<br />
						<a href="https://www.konsek.de/impressum/">Terms of use</a> |{" "}
						<a href="https://www.konsek.de/datenschutzerklaerung/">Privacy Policy</a> |{" "}
