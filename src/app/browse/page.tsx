...
/**
 *BrowsePage
 * @description Seite zum Durchsuchen von Aufgaben.
 * @remarks
 * Bietet eine Übersicht aller Aufgaben mit Suchfunktionalität.
 * @returns {JSX.Element} Die gerenderte Browse-Seite
 */
