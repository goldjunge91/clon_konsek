...
// Wenn der Benutzer versucht, auf die Route "/browse" zuzugreifen und kein Admin ist, wird er auf die Seite "/error" umgeleitet.
// Wenn der Benutzer versucht, auf die Route "/client" zuzugreifen und weder Admin noch Manager ist, wird er auf die Seite "/error" umgeleitet.
